/*
Question: What are the highest paying skillsfor data engineers?
...
- Terraform and Golang both have high median salaries at $184K, with strong demand (Terraform: 3,248 postings; Golang: 912)
...
- Most skills on the list are no longer extreme statistical outliers with just a handful of postings; instead

Takeaway: While the very top payin skill (Rust) still has less demand than major cloud and data tools 
