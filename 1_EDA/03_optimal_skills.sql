/*
Question: What are the most optimal skills for data engineers balacing both deman and salary?
- Create a ranking column that combines demand count and median salary to identify the most valuable skills.
- Focus only on remote Data Engineer positions with specified annual salaries.
    WHY?
      - This approach highlights skills that balance market demand and finacial reward. 
...
/*Here's a breakdown of the most optimal skills for Data Engineers, based on both hogh demand and high salaries:
...
- Python and SQL dominate demand (over 1100 postings each), with strong median salaris of $135K and $130K, respecting
